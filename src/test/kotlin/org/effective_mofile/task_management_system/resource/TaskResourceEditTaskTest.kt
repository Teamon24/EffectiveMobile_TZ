...
import org.effective_mofile.task_management_system.resource.TaskResourceTestUtils.taskEditing
 ...
 */
class TaskResourceEditTaskTest : IntegrationTest() {
        ...
        creator {
            ...
            send(mvc) {
                ...
                taskRepository.findOrThrow(Task::class.java, taskResponsePojo.id).apply {
                    ...
                    Assertions.assertEquals(taskEditionRequestPojo.content, taskResponsePojo.getContent())
                    AssertionsUtils.assertEnumEquals(
                        taskEditionRequestPojo.priority,
